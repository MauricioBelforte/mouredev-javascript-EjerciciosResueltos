...
console.log(a % b) //- Módulo , es decir nos devuelve el resto de la division entera
...
let myVariable = 2    //- El signo igual es de asignación
...
console.log(0 == false) //- El cero es falso
console.log(1 == false) //- Los demas numeros son verdaderos
console.log(2 == false) // El dos es verdadero
console.log(0 == "")
console.log(0 == " ")
console.log(0 == '')
console.log(0 == "Hola")
console.log(0 === "")
console.log(undefined == null) // Esto da verdadero
console.log(undefined === null) // Esto da falso
